...
# - un fisier browser.py = cel care contine implementarea browserului
# - un fisier environment.py = cel care contine instantierea tuturor obiectelor din clasele de tip page
